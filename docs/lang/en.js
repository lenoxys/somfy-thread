...
export default {
  ...
  "radio.title": "Radio settings (advanced)",
  "radio.freq": "Carrier frequency (MHz)",
  "radio.help": "One frequency for all motors. Default 433.42 (EU Somfy RTS). Only change it if motors don't respond — try 433.36–433.44 to compensate for radio drift.",
  "motor.prog": "PROG",
  "motor.open": "Open",
  "motor.close": "Close",
  "motor.my": "My",
