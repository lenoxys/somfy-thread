...
export default {
  ...
  "shades.intro": "Each shade is one roller blind driven by one Somfy motor. The easiest way to add your fleet: click Discover, then press a button on each remote in turn — the board hears it and offers it here to name and add.",
  "shades.discover": "Discover from remotes",
  "shades.addMotor": "Add a motor (no remote)",
  "shades.discoverHint": "Press and hold a button on each Somfy remote, one at a time. Each new one appears below — name it and add it.",
  "shades.discoverDone": "Done discovering",
  "shades.heardAddr": "Heard remote {addr}",
  "shades.namePlaceholder": "Name (e.g. Kitchen)",
  "shades.addHeard": "Add",
  "shades.ignore": "Ignore",
  "shades.empty": "No shades yet. Use Discover to add them from your remotes.",
  ...
  "shades.progHelp": "To add a motor without using its remote: click “Add a motor”, then press and hold the <strong>PROG</strong> button on the motor until it jogs, and click <strong>PROG</strong> in that row within a few seconds. The motor jogs again to confirm. This Somfy RF link is separate from Matter (next step).",
  ...
  "disconnect.lost": "Lost the connection to the board (unplugged?). ",
